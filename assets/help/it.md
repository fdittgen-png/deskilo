...
| Prima dell'apertura / fuori orario (inizio 6:00, 17–21) | ❌ | ❌ | ✅ per impostazione predefinita — le griglie sono libere; su **ogni** granularità la regola **Fuori dagli orari di apertura** (§8) decide quanto vale una tale finestra, o se esista affatto — vietata, solo spontanea, gratis o a pagamento (sotto) |
...
| **Solo spontaneo** | ✅ il check-in spontaneo, straordinario serale fino a mezzanotte compreso — ❌ prenotare quella finestra **in anticipo**, e ❌ una prenotazione che sfora la fine della giornata |
