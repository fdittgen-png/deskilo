...
| Antes de abrir / fuera de horario (inicio 6:00, 17–21) | ❌ | ❌ | ✅ por defecto — las rejillas son libres; en **todas** las granularidades, la política **Fuera del horario de apertura** (§8) decide cuánto vale esa ventana, o si existe siquiera — prohibida, solo espontánea, gratis o de pago (abajo) |
...
| **Solo espontáneo** | ✅ el registro espontáneo, prórroga vespertina hasta medianoche incluida — ❌ reservar esa ventana **por adelantado**, y ❌ una reserva que se pasa del fin de la jornada |
