...
El navegador hace más de lo que cabría esperar: **la Web NFC funciona** en navegadores Chromium sobre Android y por HTTPS, que es justamente como se configura desde el navegador de un teléfono la etiqueta de una silla. Lo que no puede hacer es escanear un QR con la cámara como hace el quiosco. Todo lo demás — plano, reservas, miembros, dinero, facturas, descargas de PDF — es la misma app. Al abrir el DMG de macOS por primera vez, haz clic derecho sobre la app y elige *Abrir*: la compilación aún no está notarizada por Apple, así que un doble clic normal muestra un aviso de Gatekeeper.
