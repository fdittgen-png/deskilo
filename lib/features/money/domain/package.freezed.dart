...
int get hashCode {
  final _this = this as Package;
  return Object.hash(runtimeType,_this.id,_this.workspaceId,_this.name,_this.days,_this.priceCents,_this.active,_this.vatRateId,_this.system);
}

@override
String toString() {
  final _this = this as Package;
  return 'Package(id: ${_this.id}, workspaceId: ${_this.workspaceId}, name: ${_this.name}, days: ${_this.days}, priceCents: ${_this.priceCents}, active: ${_this.active}, vatRateId: ${_this.vatRateId}, system: ${_this.system})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,workspaceId,name,days,priceCents,active,vatRateId,system);
}
