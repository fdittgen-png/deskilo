...
@useResult
$Res call({
 String id, String workspaceId, String userId, bool isAdmin, bool isOwner, MemberStatus status, int subscriptionPct, OveragePolicy overagePolicy, bool isKiosk, int? maxActiveReservations, int? maxSimultaneousReservations, String vatTreatment, String vatExemptionReason, bool canReserveLevel, CoOwnerStatus coOwner, DateTime? joinedAt, PersonalInfo managedIdentity, String managedName, String memberNumber, String? homeSiteId, Map<String, dynamic> managedAccess, DateTime? claimedAt, PaymentTerms? paymentTerms, SystemColumns system
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  PaymentTerms? paymentTerms,  SystemColumns system)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Member() when $default != null:
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.paymentTerms,_that.system);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  PaymentTerms? paymentTerms,  SystemColumns system)  $default,) {final _that = this;
switch (_that) {
case _Member():
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.paymentTerms,_that.system);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  PaymentTerms? paymentTerms,  SystemColumns system)?  $default,) {final _that = this;
switch (_that) {
case _Member() when $default != null:
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.paymentTerms,_that.system);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,workspaceId,userId,isAdmin,isOwner,status,subscriptionPct,overagePolicy,isKiosk,maxActiveReservations,maxSimultaneousReservations,vatTreatment,vatExemptionReason,canReserveLevel,coOwner,joinedAt,managedIdentity,managedName,memberNumber,homeSiteId,const DeepCollectionEquality().hash(_managedAccess),claimedAt,paymentTerms,system]);
