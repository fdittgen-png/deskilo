...
/// and for members who joined by themselves.
 DateTime? get claimedAt;/// #1110 — how this membership began. Defaults to [MemberOrigin.unknown]
...
/// person's profile.
 MemberOrigin get origin;/// #881 — the member's own payment conditions (keys on top of the
/// workspace's); null = inherit everything. Changed only through a
/// validated payment_terms_change request.
 PaymentTerms? get paymentTerms;/// #992 — the server's stamp on this row.
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Member&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.workspaceId, _this.workspaceId) || other.workspaceId == _this.workspaceId)&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.isAdmin, _this.isAdmin) || other.isAdmin == _this.isAdmin)&&(identical(other.isOwner, _this.isOwner) || other.isOwner == _this.isOwner)&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.subscriptionPct, _this.subscriptionPct) || other.subscriptionPct == _this.subscriptionPct)&&(identical(other.overagePolicy, _this.overagePolicy) || other.overagePolicy == _this.overagePolicy)&&(identical(other.isKiosk, _this.isKiosk) || other.isKiosk == _this.isKiosk)&&(identical(other.maxActiveReservations, _this.maxActiveReservations) || other.maxActiveReservations == _this.maxActiveReservations)&&(identical(other.maxSimultaneousReservations, _this.maxSimultaneousReservations) || other.maxSimultaneousReservations == _this.maxSimultaneousReservations)&&(identical(other.vatTreatment, _this.vatTreatment) || other.vatTreatment == _this.vatTreatment)&&(identical(other.vatExemptionReason, _this.vatExemptionReason) || other.vatExemptionReason == _this.vatExemptionReason)&&(identical(other.canReserveLevel, _this.canReserveLevel) || other.canReserveLevel == _this.canReserveLevel)&&(identical(other.coOwner, _this.coOwner) || other.coOwner == _this.coOwner)&&(identical(other.joinedAt, _this.joinedAt) || other.joinedAt == _this.joinedAt)&&(identical(other.managedIdentity, _this.managedIdentity) || other.managedIdentity == _this.managedIdentity)&&(identical(other.managedName, _this.managedName) || other.managedName == _this.managedName)&&(identical(other.memberNumber, _this.memberNumber) || other.memberNumber == _this.memberNumber)&&(identical(other.homeSiteId, _this.homeSiteId) || other.homeSiteId == _this.homeSiteId)&&const DeepCollectionEquality().equals(other.managedAccess, _this.managedAccess)&&(identical(other.claimedAt, _this.claimedAt) || other.claimedAt == _this.claimedAt)&&(identical(other.origin, _this.origin) || other.origin == _this.origin)&&(identical(other.paymentTerms, _this.paymentTerms) || other.paymentTerms == _this.paymentTerms)&&(identical(other.system, _this.system) || other.system == _this.system));
}
...
int get hashCode {
  final _this = this as Member;
  return Object.hashAll([runtimeType,_this.id,_this.workspaceId,_this.userId,_this.isAdmin,_this.isOwner,_this.status,_this.subscriptionPct,_this.overagePolicy,_this.isKiosk,_this.maxActiveReservations,_this.maxSimultaneousReservations,_this.vatTreatment,_this.vatExemptionReason,_this.canReserveLevel,_this.coOwner,_this.joinedAt,_this.managedIdentity,_this.managedName,_this.memberNumber,_this.homeSiteId,const DeepCollectionEquality().hash(_this.managedAccess),_this.claimedAt,_this.origin,_this.paymentTerms,_this.system]);
}

@override
String toString() {
  final _this = this as Member;
  return 'Member(id: ${_this.id}, workspaceId: ${_this.workspaceId}, userId: ${_this.userId}, isAdmin: ${_this.isAdmin}, isOwner: ${_this.isOwner}, status: ${_this.status}, subscriptionPct: ${_this.subscriptionPct}, overagePolicy: ${_this.overagePolicy}, isKiosk: ${_this.isKiosk}, maxActiveReservations: ${_this.maxActiveReservations}, maxSimultaneousReservations: ${_this.maxSimultaneousReservations}, vatTreatment: ${_this.vatTreatment}, vatExemptionReason: ${_this.vatExemptionReason}, canReserveLevel: ${_this.canReserveLevel}, coOwner: ${_this.coOwner}, joinedAt: ${_this.joinedAt}, managedIdentity: ${_this.managedIdentity}, managedName: ${_this.managedName}, memberNumber: ${_this.memberNumber}, homeSiteId: ${_this.homeSiteId}, managedAccess: ${_this.managedAccess}, claimedAt: ${_this.claimedAt}, origin: ${_this.origin}, paymentTerms: ${_this.paymentTerms}, system: ${_this.system})';
}
...
@useResult
$Res call({
 String id, String workspaceId, String userId, bool isAdmin, bool isOwner, MemberStatus status, int subscriptionPct, OveragePolicy overagePolicy, bool isKiosk, int? maxActiveReservations, int? maxSimultaneousReservations, String vatTreatment, String vatExemptionReason, bool canReserveLevel, CoOwnerStatus coOwner, DateTime? joinedAt, PersonalInfo managedIdentity, String managedName, String memberNumber, String? homeSiteId, Map<String, dynamic> managedAccess, DateTime? claimedAt, MemberOrigin origin, PaymentTerms? paymentTerms, SystemColumns system
});
...
as MemberOrigin,paymentTerms: freezed == paymentTerms ? _self.paymentTerms : paymentTerms // ignore: cast_nullable_to_non_nullable
as PaymentTerms?,system: null == system ? _self.system : system // ignore: cast_nullable_to_non_nullable
as SystemColumns,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  MemberOrigin origin,  PaymentTerms? paymentTerms,  SystemColumns system)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Member() when $default != null:
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.origin,_that.paymentTerms,_that.system);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  MemberOrigin origin,  PaymentTerms? paymentTerms,  SystemColumns system)  $default,) {final _that = this;
switch (_that) {
case _Member():
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.origin,_that.paymentTerms,_that.system);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String workspaceId,  String userId,  bool isAdmin,  bool isOwner,  MemberStatus status,  int subscriptionPct,  OveragePolicy overagePolicy,  bool isKiosk,  int? maxActiveReservations,  int? maxSimultaneousReservations,  String vatTreatment,  String vatExemptionReason,  bool canReserveLevel,  CoOwnerStatus coOwner,  DateTime? joinedAt,  PersonalInfo managedIdentity,  String managedName,  String memberNumber,  String? homeSiteId,  Map<String, dynamic> managedAccess,  DateTime? claimedAt,  MemberOrigin origin,  PaymentTerms? paymentTerms,  SystemColumns system)?  $default,) {final _that = this;
switch (_that) {
case _Member() when $default != null:
return $default(_that.id,_that.workspaceId,_that.userId,_that.isAdmin,_that.isOwner,_that.status,_that.subscriptionPct,_that.overagePolicy,_that.isKiosk,_that.maxActiveReservations,_that.maxSimultaneousReservations,_that.vatTreatment,_that.vatExemptionReason,_that.canReserveLevel,_that.coOwner,_that.joinedAt,_that.managedIdentity,_that.managedName,_that.memberNumber,_that.homeSiteId,_that.managedAccess,_that.claimedAt,_that.origin,_that.paymentTerms,_that.system);case _:
  return null;
...
class _Member extends Member {
  const _Member({required this.id, required this.workspaceId, required this.userId, required this.isAdmin, required this.isOwner, required this.status, this.subscriptionPct = 100, this.overagePolicy = OveragePolicy.blocked, this.isKiosk = false, this.maxActiveReservations, this.maxSimultaneousReservations, this.vatTreatment = 'auto', this.vatExemptionReason = '', this.canReserveLevel = false, this.coOwner = CoOwnerStatus.none, this.joinedAt, this.managedIdentity = PersonalInfo.empty, this.managedName = '', this.memberNumber = '', this.homeSiteId,  Map<String, dynamic> managedAccess = const <String, dynamic>{}, this.claimedAt, this.origin = MemberOrigin.unknown, this.paymentTerms, this.system = SystemColumns.none}): _managedAccess = managedAccess,super._();
...
/// no answer, and inventing one would put a wrong chip on a real
/// person's profile.
@override@JsonKey() final  MemberOrigin origin;
