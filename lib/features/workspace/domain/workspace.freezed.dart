...
class _Workspace extends Workspace {
  const _Workspace({required this.id, required this.name, required this.countryCode, required this.currencyCode, required this.timezone, required this.inviteCode, final  Map<String, dynamic> featureFlags = const <String, dynamic>{}, final  Map<String, dynamic> rolePermissions = const <String, dynamic>{}, final  Map<String, dynamic> branding = const <String, dynamic>{}, this.devMode = false, this.environment = 'dev', this.pairId = '', final  Map<String, dynamic> paymentInstructions = const <String, dynamic>{}, this.whatsappGroup = '', this.address = '', this.vatRegime = 'not_subject', this.vatId = '', this.legalId = '', this.taxExemptionReason = '', this.street = '', this.city = '', this.postalCode = '', this.vatAccount = '', this.subscriptionVatRateId = '', this.deskOpacity = 100, this.invitationTemplate = '', final  Map<String, dynamic> invoiceLegal = const <String, dynamic>{}, this.defaultLocale = '', final  Map<String, dynamic> invitationTemplates = const <String, dynamic>{}, this.system = SystemColumns.none}): _featureFlags = featureFlags,_rolePermissions = rolePermissions,_branding = branding,_paymentInstructions = paymentInstructions,_invoiceLegal = invoiceLegal,_invitationTemplates = invitationTemplates,super._();
