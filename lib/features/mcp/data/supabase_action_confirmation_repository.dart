...
class SupabaseActionConfirmationRepository
    implements ActionConfirmationRepository {
  ...
  Future<ActionConfirmation> get(String id) async {
    try {
      ...
      TraceLogger.instance.warn(
        'mcp',
        'confirmations are absent on this server',
        error: e,
        stackTrace: st,
      );
  ...
  Future<ConfirmationStatus> respond(String id, {required bool accept}) async {
    final answer = await _client.rpc<Object?>(
      'mcp_confirm_action',
