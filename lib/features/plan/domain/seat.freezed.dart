...
/// lowercase hex); tapping it resolves to this seat like its QR.
 String? get nfcUid;/// #992 — the server's stamp on this row.
...
@useResult
$Res call({
 String id, String workspaceId, String deskId, String name, int x, int y, SeatOrientation orientation, String chair, List<String> amenities, DateTime? blockedFrom, DateTime? blockedTo, String? nfcUid, SystemColumns system
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String deskId,  String name,  int x,  int y,  SeatOrientation orientation,  String chair,  List<String> amenities,  DateTime? blockedFrom,  DateTime? blockedTo,  String? nfcUid,  SystemColumns system)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Seat() when $default != null:
return $default(_that.id,_that.workspaceId,_that.deskId,_that.name,_that.x,_that.y,_that.orientation,_that.chair,_that.amenities,_that.blockedFrom,_that.blockedTo,_that.nfcUid,_that.system);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String workspaceId,  String deskId,  String name,  int x,  int y,  SeatOrientation orientation,  String chair,  List<String> amenities,  DateTime? blockedFrom,  DateTime? blockedTo,  String? nfcUid,  SystemColumns system)  $default,) {final _that = this;
switch (_that) {
case _Seat():
return $default(_that.id,_that.workspaceId,_that.deskId,_that.name,_that.x,_that.y,_that.orientation,_that.chair,_that.amenities,_that.blockedFrom,_that.blockedTo,_that.nfcUid,_that.system);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String workspaceId,  String deskId,  String name,  int x,  int y,  SeatOrientation orientation,  String chair,  List<String> amenities,  DateTime? blockedFrom,  DateTime? blockedTo,  String? nfcUid,  SystemColumns system)?  $default,) {final _that = this;
switch (_that) {
case _Seat() when $default != null:
return $default(_that.id,_that.workspaceId,_that.deskId,_that.name,_that.x,_that.y,_that.orientation,_that.chair,_that.amenities,_that.blockedFrom,_that.blockedTo,_that.nfcUid,_that.system);case _:
  return null;
...
/// Create a copy of Seat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? workspaceId = null,Object? deskId = null,Object? name = null,Object? x = null,Object? y = null,Object? orientation = null,Object? chair = null,Object? amenities = null,Object? blockedFrom = freezed,Object? blockedTo = freezed,Object? nfcUid = freezed,Object? system = null,}) {
  return _then(_Seat(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,workspaceId: null == workspaceId ? _self.workspaceId : workspaceId // ignore: cast_nullable_to_non_nullable
as String,deskId: null == deskId ? _self.deskId : deskId // ignore: cast_nullable_to_non_nullable
