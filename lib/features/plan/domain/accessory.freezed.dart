...
int get hashCode {
  final _this = this as Accessory;
  return Object.hash(runtimeType,_this.id,_this.workspaceId,_this.name,_this.supplementCents,_this.active,_this.sortOrder,_this.vatRateId,_this.system);
}

@override
String toString() {
  final _this = this as Accessory;
  return 'Accessory(id: ${_this.id}, workspaceId: ${_this.workspaceId}, name: ${_this.name}, supplementCents: ${_this.supplementCents}, active: ${_this.active}, sortOrder: ${_this.sortOrder}, vatRateId: ${_this.vatRateId}, system: ${_this.system})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,workspaceId,name,supplementCents,active,sortOrder,vatRateId,system);
}
