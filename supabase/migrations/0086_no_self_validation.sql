...
-- the actor was admitted to the pool when it was otherwise empty. The
-- subject-as-fallback path stays: the subject of someone ELSE's action
-- is another person. Everything below the eligibility check is the
-- 0072 body unchanged.
