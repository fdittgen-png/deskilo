...
// 1110→1140 (2026-08-24): #620 the occupant-photo loader wrap on the
  ...
  'lib/features/workspace/presentation/screens/features_screen.dart': 190, // 2026-09-16 #1327 242→190: the surface headings and the tile loop became widgets/feature_capability_list.dart, so the screen keeps the filtering and the list keeps the rendering // 2026-09-13 #1190 690→360: the 425 lines of switch descriptions became presentation/feature_copy.dart, which left room for the search the screen needed// 2026-09-11 #1063 the two tier headings and the reindented tile loop // 2026-09-11 #1110 + #1119 descriptions // 2026-09-07 #987 environmentPairs description beside #985's two
  ...
  'lib/features/workspace/domain/workspace_repository.dart': 681, // 2026-09-16 #1303 671→681: the request id and template parameters, documented; // 2026-09-11 #1120 the library surface of the interface, documented per method (was the 600 default)
