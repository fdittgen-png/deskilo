...
const Map<String, int> _baseline = {
  ...
  // substitution, and the sentence saying which personal thing the row
...
// 1110→1140 (2026-08-24): #620 the occupant-photo loader wrap on the
  ...
  'lib/features/profile/presentation/screens/settings_screen.dart': 1055, // 2026-09-26 #1626/#1627/#1628 1053→1055: one import and one line for the assistant entries, which live in mcp/presentation/widgets/mcp_settings_tiles.dart; // 2026-09-20 #1598 1045→1053: the screen answers to the name the entry used — the permission import, the predicate call on the AppBar title and the paragraph saying why the same route may wear two names; // 2026-09-20 #1514 1039→1045: the invoice-identity form refuses to save while filming mode is on — the guard, its import and the sentence saying why a prefilled pseudonym must not be written back; // 2026-09-16 #1307 S3 1240→1039: the workspace sections left for settings_workspace_sections.dart; // 2026-09-11 #1154 1420→1316: the 723-line build() became four section methods; About and the section header moved to widgets/ // 2026-09-06 #970 the demo-mode switch and the address-dialog guard // 2026-09-06 #969 the navigation tile and its dialog // 2026-08 #586 default-period tile + dialog // 2026-09-05 #886 the personal-information tile beside the legacy address dialog it replaces // 2026-09-05 #902 the payment-conditions tile // 2026-09-08 #1019 twenty-two help symbols now name the exact setting they document (HelpAnchor), one named argument per symbol
