...
**El registro.** El icono de lista en la barra de Facturas abre un libro con una línea por factura: **fecha · nombre · importe · estado**, ordenado por fecha (toca la cabecera Fecha para invertirlo), con la suma al pie. La columna *nombre* sigue a quien lee — quien emite repasa miembros, un miembro repasa sus propios números de factura. Los miembros solo ven lo que les concierne: las emitidas, nunca una anulada.
