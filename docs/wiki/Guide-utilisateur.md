...
- **Envoyer une notification** (dans la fiche détaillée, et sur les fiches membres de *Membres & abonnements*) : une courte note à un autre membre — livrée en push et en notification avec votre nom et votre message. Les admins disposent d'un mégaphone **Notifier tous les admins** dans l'en-tête, qui atteint tous les admins, propriétaire inclus. Activable/désactivable via la fonctionnalité *Notifications entre membres*.
