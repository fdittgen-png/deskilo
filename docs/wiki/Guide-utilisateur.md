...
| Avant l'ouverture / après les heures (début 6:00, 17–21) | ❌ | ❌ | ✅ par défaut — les grilles sont libres ; sur **toutes** les granularités, la règle **En dehors des heures d'ouverture** (§8) décide de ce que vaut une telle fenêtre, voire si elle existe — interdite, spontanée seulement, gratuite ou facturée (ci-dessous) |
...
| **Spontané uniquement** | ✅ le pointage spontané, prolongation du soir jusqu'à minuit comprise — ❌ réserver cette fenêtre **à l'avance**, et ❌ une réservation qui dépasse la fin de journée |
