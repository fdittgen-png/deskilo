...
| Vor Öffnung / nach Feierabend (Start 6:00, 17–21) | ❌ | ❌ | ✅ standardmäßig — die Raster sind frei; auf **jeder** Granularität entscheidet die Regel **Außerhalb der Öffnungszeiten** (§8), was ein solches Fenster wert ist oder ob es überhaupt zustande kommt — abgelehnt, nur spontan, gratis oder berechnet (unten) |
...
| **Nur spontan** | ✅ der Spontan-Check-in, Abend-Überstunde bis Mitternacht eingeschlossen — ❌ dieses Fenster **im Voraus** zu buchen, und ❌ eine Buchung über das Tagesende hinaus |
