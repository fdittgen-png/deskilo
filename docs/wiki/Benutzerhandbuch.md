...
4. Am Kiosk: Platz (oder **Diese Etage**) antippen → **Einchecken**, **Reservieren** oder **Auschecken**. Für Einchecken und Reservieren kommt zuerst ein **Zeitraum-Schritt** — du sagst *wann*, bevor ein Badge herauskommt, **nur heute** und getreu der Granularität des Space: bei Halbtagen **Vormittag / Nachmittag / Tag**-Chips (ein laufendes Fenster startet *jetzt*, vergangene sind deaktiviert, nach Feierabend bleibt ein einzelnes *Rest des Tages*); bei Zeit-Granularitäten **Von/Bis**-Picker auf dem Slot-Raster — Einchecken heißt da sein, der Start ist also auf *jetzt* fixiert, nur das Ende bewegt sich. Eine schon begonnene Reservierung fragt zusätzlich **Sofort einchecken?** (standardmäßig an — du stehst ja am Kiosk): Bestätigen bucht die Reservierung *bereits eingecheckt*, mit einer einzigen Badge-Präsentation. Dann Badge zeigen:
